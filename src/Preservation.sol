...
contract Preservation {
    ...
    function setFirstTime(uint256 _timeStamp) public returns (bool) {
        // remove unused local variable warning
    ...
    function setSecondTime(uint256 _timeStamp) public returns (bool) {
        // remove unused local variable warning
